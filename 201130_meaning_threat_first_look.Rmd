...
library(pwr)
g <- 
  ggplot(test, aes(x=InCS, y=perc, fill=factor(condition,labels=c("Jennifer","Julie and Mark")))) +
...
```{r S1fig2criticalcondition, fig.cap="Study 1: Responses to critical slide and for the *Incest* group (*N* = 141) and the *Cannibal* group (*N* = 142)", include=TRUE}
