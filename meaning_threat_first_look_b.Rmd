...
table(df3$InCS,df3$condition1)

con_table <- tapply(df3$Defense, df3$InCS_neat, descriptives)


a <- aov(Defense~InCS_neat, df3)
TukeyHSD(a)
...
```{r additionalanalysis3, fig.cap="Study 2: Defense score depending on response to Critical Slide", include=TRUE}
apa_barplot(
  data = df3
  , id = "ID"
  , factors = "InCS_neat"
